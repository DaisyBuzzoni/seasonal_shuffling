...
Sofav_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ofav_wide.csv')
Sssid_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ssid_wide.csv')
Smcav_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/mcav_wide.csv')
Wofav_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/Wofav_wide.csv')
Wssid_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/Wssid_wide.csv')
Wmcav_wide=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/Wmcav_wide.csv')
...
bleaching_tidy=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/bleaching_tidy_dates.csv')
...
```{r,echo=F}
ofav_DHW=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ofav_bleaching_DHW.csv')
ssid_DHW=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ssid_bleaching_DHW.csv')
mcav_DHW=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/mcav_bleaching_DHW.csv')
ofav_recov=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ofav_recov_days.csv')
ssid_recov=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/ssid_recov_days.csv')
mcav_recov=read.csv('/Users/Daisy/Documents/CRFL/Tissue vectoring/qPCR/R/Emerald_vector_cores/mcav_recov_days.csv')
ofav=expression(paste(italic("O. faveolata")))
ssid=expression(paste(italic("S. siderea")))
mcav=expression(paste(italic("M. cavernosa"))) 
```
...
### Coral species and dominant symbiont genus both shape the trajectories of symbiont loss and recovery over bleaching.
...
```
Other questions for Ross: 1. Light intensity calculation. 
2. Based on a reviewer comment replacement of D. trenchii with Durusdinium. 