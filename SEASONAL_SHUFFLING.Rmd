...
summary(ssidemm.sh2) #alternatively, by backtransforming the predicted means for each batch, we can then calculate the percentage change, which may be more intuitive to interpret.
