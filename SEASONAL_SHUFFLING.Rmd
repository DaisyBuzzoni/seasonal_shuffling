...
### Figure 1b: M. cavernosa symbionts per host cell increased from April to October- changes dependent on dominant symbiont in O. faveolata and S. siderea
...
theme(legend.title = element_markdown(size=9), legend.text=element_text(size=9),legend.position = c(0.6,0.9))+
